                ...
                <form method="GET" action="{{ route('admin.resignations.index') }}" class="row g-3">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        ...
                        <select name="status" id="status" class="form-control">
                            ...
                            <option value="hr_approved" {{ request('status') == 'hr_approved' ? 'selected' : '' }}>HR
                                Approved</option>
                            <option value="manager_approved"
                                {{ request('status') == 'manager_approved' ? 'selected' : '' }}>Manager Approved
                            </option>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        ...
                        <select name="resignation_type" id="resignation_type" class="form-control">
                            ...
                            <option value="voluntary"
                                {{ request('resignation_type') == 'voluntary' ? 'selected' : '' }}>
                                Voluntary</option>
                            <option value="retirement"
                                {{ request('resignation_type') == 'retirement' ? 'selected' : '' }}>Retirement</option>
                            <option value="contract_end"
                                {{ request('resignation_type') == 'contract_end' ? 'selected' : '' }}>Contract End
                            </option>
                        </select>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-12">
