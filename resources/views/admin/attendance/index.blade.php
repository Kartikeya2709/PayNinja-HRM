                        ...
                        <div class="record-btn btn-center">
                            ...
                            <div class="btn-group ms-2">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><a class="dropdown-item export-btn" href="#" data-type="excel"><i
                                                class="bi bi-file-earmark-excel me-2"></i>Export to Excel</a></li>
                                    <li><a class="dropdown-item export-btn" href="#" data-type="pdf"><i
                                    ...
                                    <div class="row g-2 align-items-end justify-content-space-between">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control form-control-sm daterange"
                                                id="date_range" name="date_range" value="{{ request('date_range') }}"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-select form-select-sm" id="status" name="status">
                                                ...
                                                <option value="On Leave"
                                                    {{ request('status') == 'On Leave' ? 'selected' : '' }}>On Leave
                                                </option>
                                                <option value="Half Day"
                                                    {{ request('status') == 'Half Day' ? 'selected' : '' }}>Half Day
                                                </option>
                                                <option value="Holiday"
                                                    {{ request('status') == 'Holiday' ? 'selected' : '' }}>Holiday
                                                </option>
                                                <option value="Week-Off"
                                                    {{ request('status') == 'Week-Off' ? 'selected' : '' }}>Week-Off
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <i class="bi bi-geo-alt-fill text-primary ms-1" data-bs-toggle="tooltip"
                    ...
                    <div class="card bg-light">
                        ...
                        <div class="card-body small">
                            <ol class="mb-0">
                                ...
                                <li>Required fields: <code>employee_id</code>, <code>date</code>, <code>status</code>
                                </li>
                                <li>Date format: YYYY-MM-DD</li>
                                <li>Time format: HH:MM:SS (24-hour format)</li>
                                <li>Valid status values: Present, Absent, Late, On Leave, Half Day, Holiday, Week-Off
                                </li>
                            </ol>
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    $('#filterForm').on('submit', function(e) {
        ...
        if (dateRange) {
            ...
            if (dates.length !== 2 || !moment(dates[0], 'YYYY-MM-DD', true).isValid() || !moment(dates[
                    1], 'YYYY-MM-DD', true).isValid()) {
                e.preventDefault();
                showToast('Error', 'Please select a valid date range in the format YYYY-MM-DD',
                'error');
                return false;
            }
    ...
    $(document).on('click', '.edit-attendance', function() {
        ...
        $.ajax({
            url: `/attendance-management/attendance/${id}/edit`,
            type: 'GET',
            success: function(response) {
                ...
                $('#edit_check_in').val(response.check_in ? response.check_in.substring(0,
                    5) : '');
                $('#edit_check_out').val(response.check_out ? response.check_out.substring(
                    0, 5) : '');
