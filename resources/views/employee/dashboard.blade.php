                ...
                <div class="row">
                    <div class="col-lg-3 px-1">
                        <div class="employee-check-in">
                            ...
                            <div class="col-lg-12">
                                <a href="{{ route('leaves.my-leaves.leave-requests.create') }}" class="card card-link">
                                    <div class="card-body text-center d-flex align-items-center">
                    ...
                    <div class="col-lg-3 px-1 cash-dep mobile-space">
                        <div class="card leave">
                            ...
                            <div class="text-center">
                                <a href="{{ route('leaves.my-leaves.leave-requests.index') }}" class="btn btn-sm btn-warning mt-4">
                                    View Leave History
                                </a>
                            </div>
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover align-middle mb-0">
                                        ...
                                        <tbody>
                                            @php
                                                $filtered = $announcements->filter(function ($a) {
                                                    return $a->audience === 'employees' || $a->audience === 'both';
                                                });
                                            @endphp
                                    ...
                                    <div class="col-lg-8 col-md-12">
                                        <div class="mb-2">
                                            ...
                                            @if (isset($todayAttendance) && $todayAttendance->check_in)
                                                <span
                                                    class="ml-2">{{ \Carbon\Carbon::parse($todayAttendance->check_in)->format('h:i A') }}</span>
                                            @else
                                        ...
                                        <div class="mb-2">
                                            ...
                                            @if (isset($todayAttendance) && $todayAttendance->check_out)
                                                <span
                                                    class="ml-2">{{ \Carbon\Carbon::parse($todayAttendance->check_out)->format('h:i A') }}</span>
                                            @else
                                        ...
                                        <div>
                                            ...
                                            @if (isset($todayAttendance))
                                                ...
                                                @else
                                                    <span
                                                        class="badge badge-secondary">{{ $todayAttendance->status }}</span>
                                                @endif
                                                ...
                                                @if ($todayAttendance->check_in && $todayAttendance->check_out)
                                                    ...
                                                    @endphp
                                                    <span
                                                        class="ml-2 text-muted">({{ sprintf('%d:%02d', $hours, $minutes) }}
                                                        hrs)</span>
                                                @endif
                                            @else
                            ...
                            <div class="card-body emp-dashboard">
                                <div class="row align-items-center today-status">
                                    ...
                                    <div class="col-lg-8 col-sm-12">
                                        ...
                                        <a href="{{ route('leaves.my-leaves.leave-requests.index') }}"
        ...
        new Chart(attendanceCtx, {
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Monthly Attendance Trend (' + currentYear + ')'
                    }
                },
                scales: {
                    x: {
