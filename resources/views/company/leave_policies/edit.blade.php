    ...
    <div class="section-body">
        <div class="row">
            <div class="col-8 mx-auto">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('company.leave-policies.update', $leavePolicy->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                                ...
                                <select name="financial_year_id"
                                    ...
                                    @foreach($financialYears as $year)
                                        <option value="{{ $year->id }}"
                                            {{ $leavePolicy->financial_year_id == $year->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea name="description"
                                          ...
                                          rows="3"
                                          placeholder="Policy description and details">{{ $leavePolicy->description }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
