...
<section class="section container">
    ...
    <form action="{{ route('company.leave-balances.update', $leaveBalance->id) }}" method="POST" class="leave-balance-form">
        @csrf
        @method('PUT')
        ...
        <div class="mt-4 text-center">
            ...
            <a href="{{ route('company.leave-balances.index') }}" class="btn btn-danger px-4 rounded-pill ms-2">
