        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('employees.management.store') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="tab-pane fade" id="job" role="tabpanel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('employment_type_id') is-invalid @enderror" id="employment_type_id" name="employment_type_id" required>
