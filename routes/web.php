...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['superadmin'])->prefix('superadmin')->name('superadmin.')->group(function () {
        ...
        Route::get('setting/slug/edit/{id}/visible', [SlugController::class, 'edit_slug'])->name('setting.slug.visible');
        Route::post('setting/slug/edit/{id}/post', [SlugController::class, 'edit_slug'])->name('setting.slug.edit.post');
        ...
        Route::get('database/table/{table}/visible', [DatabaseController::class, 'showTable'])->name('database.show');
        Route::post('database/table/{table}/post', [DatabaseController::class, 'showTable'])->name('database.show');
        ...
        Route::get('database/query/visible', [DatabaseController::class, 'query'])->name('database.query');
        Route::post('database/query/post', [DatabaseController::class, 'query'])->name('database.query');

        Route::post('database/execute-query', [DatabaseController::class, 'executeQuery'])->name('database.execute-query');
    ...
    Route::middleware('checkAccess')->group(function () {
        ...
        Route::put('field-visit-update/{encryptedId}', [FieldVisitController::class, 'update'])->name('field-visits.update');
        Route::delete('field-visit-delete/{encryptedId}', [FieldVisitController::class, 'destroy'])->name('field-visits.destroy');
        Route::post('/field-visits', [FieldVisitController::class, 'store'])->name('field-visits.store');
        Route::post('/field-visits/{encryptedId}/approve', [FieldVisitController::class, 'approve'])->name('field-visits.approve');
        Route::post('/field-visits/{encryptedId}/reject', [FieldVisitController::class, 'reject'])->name('field-visits.reject');
        Route::post('/field-visits/{encryptedId}/start', [FieldVisitController::class, 'start'])->name('field-visits.start');
        Route::post('/field-visits/{encryptedId}/complete', [FieldVisitController::class, 'complete'])->name('field-visits.complete');
        ...
        Route::prefix('employees-management')->name('employees.management.')->group(function () {
            Route::get('/index', [\App\Http\Controllers\CompanyAdminController::class, 'employees'])->name('index');
            ...
            Route::get('/{encryptedId}/view', [\App\Http\Controllers\CompanyAdminController::class, 'viewEmployee'])->name('view');
            Route::get('/{encryptedId}/edit', [\App\Http\Controllers\CompanyAdminController::class, 'editEmployee'])->name('edit');
            Route::put('/{encryptedId}/update', [\App\Http\Controllers\CompanyAdminController::class, 'updateEmployee'])->name('update');
            Route::put('/{encryptedId}/role', [\App\Http\Controllers\CompanyAdminController::class, 'updateEmployeeRole'])->name('update-role');
            Route::post('/{encryptedId}/toggle-status', [\App\Http\Controllers\CompanyAdminController::class, 'toggleStatus'])->name('toggleStatus');
